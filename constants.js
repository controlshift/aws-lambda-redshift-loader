...
entries = 'entries';
status = 'status';
configTable = process.env.OVERRIDE_CONFIG_TABLE || 'LambdaRedshiftBatchLoadConfig';
batchTable = process.env.OVERRIDE_BATCH_TABLE || 'LambdaRedshiftBatches';
batchStatusGSI = 'LambdaRedshiftBatchStatus';
filesTable = process.env.OVERRIDE_FILES_TABLE || 'LambdaRedshiftProcessedFiles';
